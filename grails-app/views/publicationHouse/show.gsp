...
<html>
    ...
    <body>
        ...
        <div id="show-publicationHouse" class="content scaffold-show" role="main">
            ...
            <f:display bean="publicationHouse" />
            <g:form resource="${this.publicationHouse}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.publicationHouse}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
